...
namespace Sorveteria.Dao
{
    public abstract class OracleRepository
    {
        ...
        protected void OpenConnection(bool closeAfterExecution = true)
        {
            ...
            if (_connection == null)
                _connection = new OracleConnection("User Id=Daniel;Data Source=localhost;Password=123");
    ...
    public static class NullSafeGetter
    {
        ...
        public static T GetValueOrDefault<T>(this string columnName, IDataRecord r, string sourceFilePath = "")
        {
            try
            {
                return r[columnName] == DBNull.Value ? default(T) : (T)r[columnName];
